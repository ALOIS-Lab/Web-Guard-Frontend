...
export default function Login() {
  ...
  const onOauth = (provider) => {
    setOauthNote(
      `${provider} sign-in is not connected yet. Use your email and password below to continue.`
    );
  };
  ...
  return (
    <AuthShell>
      ...
      <div className="flex items-center justify-end gap-2 text-sm text-muted mb-6">
        <span className="hidden sm:inline">New to WebGuard?</span>
        <Link
          to="/signup"
      ...
      <h1 className="text-3xl font-bold tracking-tight text-ink">
        Welcome <span className="text-assure">Back</span>
      </h1>
      <p className="mt-1.5 text-sm text-muted">Sign in to continue monitoring with WebGuard</p>
